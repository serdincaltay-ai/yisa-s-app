...
ALTER TABLE user_tenants ADD CONSTRAINT user_tenants_role_check
  CHECK (role IN ('patron','admin','manager','antrenor','trainer','kasa','sekreter','temizlik','guvenlik','veli','staff','viewer','owner','tesis_muduru','sportif_direktor','yardimci_antrenor','pasif'));
