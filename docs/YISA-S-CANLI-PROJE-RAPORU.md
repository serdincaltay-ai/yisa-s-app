...
### Faz 1 — Vitrin + Demo + Tesis Sayfaları + ManyChat (~%97)
...
### Faz 6 — Veli Paneli MVP + Stripe Ödeme (~%97)
...
### Faz 7 — CELF Zinciri + Başlangıç Görevleri + E2E Testler (~%90)
