...
export const INITIAL_TASKS: Record<DirectorKey, InitialTask[]> = {
  CFO: [
    ...
    },
    {
      ...
      requiresApproval: false,
      aiProvider: 'GPT',
      command: 'Jimnastik tesisi için aylık gelir-gider rapor şablonu oluştur',
      status: 'pending',
    },
  ],
  CTO: [
  ...
  CMO: [
    {
      ...
      requiresApproval: false,
      aiProvider: 'GPT',
      command: 'Jimnastik tesisi için haftalık Instagram/Facebook içerik planı oluştur',
      status: 'pending',
    },
    {
      id: 'CMO-002',
  ...
  CLO: [
    {
      ...
      requiresApproval: true,
      aiProvider: 'CLAUDE',
      command: 'Jimnastik tesisi için KVKK aydınlatma metni ve açık rıza formu oluştur',
      status: 'pending',
    },
    {
      id: 'CLO-002',
      ...
      requiresApproval: true,
      aiProvider: 'CLAUDE',
      command: 'Jimnastik tesisi üyelik sözleşmesi şablonu oluştur: Şartlar, iptal, sorumluluklar',
      status: 'pending',
    },
  ],
  CSO_SATIS: [
    ...
    },
    {
      ...
      requiresApproval: false,
      aiProvider: 'GPT',
      command: 'Jimnastik tesisi için telefon satış scripti oluştur: Tanışma, ihtiyaç analizi, kapanış',
      status: 'pending',
    },
  ],
  CPO: [
    ...
    },
    {
      ...
      requiresApproval: true,
      aiProvider: 'V0',
      command: 'Jimnastik tesisi için modern, responsive web sitesi şablonu tasarla',
      status: 'pending',
    },
  ],
  CDO: [
  ...
  CCO: [
    ...
    },
    {
      ...
      requiresApproval: false,
      aiProvider: 'CLAUDE',
      command: 'Jimnastik tesisi için SSS dokümanı oluştur: Kayıt, ödeme, program, kurallar',
      status: 'pending',
    },
  ],
  CSO_STRATEJI: [
    {
      ...
      requiresApproval: true,
      aiProvider: 'GPT',
      command: 'Jimnastik tesisi için Q1 hedefleri oluştur: Sporcu, gelir, memnuniyet hedefleri',
      status: 'pending',
    },
  ],
  CSPO: [
    {
      ...
      description: 'Temel jimnastik hareketlerinin tanımlı olduğunu doğrula',
      priority: 'high',
      estimatedMinutes: 30,
      requiresApproval: false,
      aiProvider: 'CLAUDE',
      command: 'movements tablosunu kontrol et, temel jimnastik hareketlerini ekle (varsa güncelle)',
      status: 'pending',
    },
    {
      id: 'CSPO-002',
      ...
      requiresApproval: true,
      aiProvider: 'CLAUDE',
      command: 'Jimnastik için 10 seviyeli sporcu değerlendirme sistemi oluştur',
      status: 'pending',
    },
    {
      id: 'CSPO-003',
