...
export default function AntrenorBildirimPage() {
  return (
    <main className="p-4 space-y-4">
      ...
      <p className="text-sm text-zinc-400">0 okunmamis bildirim</p>

      {/* Filtre sekmeleri */}
      <div className="flex gap-2 overflow-x-auto pb-2">
        {['Tumu', 'Okunmamis', 'Yoklama', 'Sporcu', 'Duyuru'].map((tab, i) => (
          <button
            key={tab}
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-white mb-2">Yakinda</h2>
        <p className="text-sm text-zinc-400 max-w-sm">
          Bildirimler yakinda aktif olacak. Yoklama, sporcu ve duyuru bildirimleri burada goruntulenecek.
        </p>
      </div>
      ...
      <div className="space-y-3 opacity-40">
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="font-medium text-white text-sm">Ders Degisikligi</p>
            <p className="text-xs text-zinc-500 mt-1">Cumartesi dersi 10:00 olarak guncellendi.</p>
            <p className="text-[10px] text-zinc-600 mt-2">2 saat once</p>
          </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-zinc-500 mt-1">Ali Yilmaz grubunuza eklendi.</p>
            <p className="text-[10px] text-zinc-600 mt-2">1 gun once</p>
          </div>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-zinc-500 mt-1">Yariyil tatili programi yayinlandi.</p>
            <p className="text-[10px] text-zinc-600 mt-2">3 gun once</p>
          </div>
        </div>
      </div>
    </main>
