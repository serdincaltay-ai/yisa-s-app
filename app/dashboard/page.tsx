...
import { LogOut, Home, Users, Settings, BarChart3, MessageSquare, Bot } from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 p-4">
        ...
        <nav className="space-y-2">
          ...
          <a href="/robots" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition-colors">
            <Bot size={20} />
            Robotlar
          </a>
      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <a href="/robots" className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 hover:border-amber-500/50 transition-colors cursor-pointer">
            <div className="flex items-center gap-2 mb-1">
              <Bot size={16} className="text-amber-500" />
              <p className="text-slate-400 text-sm">Aktif Robot</p>
            </div>
            <p className="text-3xl font-bold text-amber-400">7</p>
            <p className="text-xs text-emerald-400 mt-1">6 aktif • 1 beklemede</p>
          </a>
