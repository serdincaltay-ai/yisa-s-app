...
export default function OgrenciYonetimiPage() {
  ...
  const filteredByAge = items.filter((a) => {
    ...
    <div className="min-h-screen bg-zinc-950 text-white p-6 space-y-6">
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-zinc-400">Sporcu listesi, ekle/duzenle, filtrele — Supabase CRUD</p>
        </div>
        <Button onClick={openAdd} className="bg-cyan-600 hover:bg-cyan-500 text-white">
          <Plus className="h-4 w-4 mr-2" />Yeni Ogrenci
        </Button>
      </header>
