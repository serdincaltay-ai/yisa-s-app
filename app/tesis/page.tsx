      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href="/tesis/saglik"><HeartPulse className="mr-2 h-4 w-4" />Saglik Takibi</Link>
            </Button>
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href="/tesis/antrenorler"><Dumbbell className="mr-2 h-4 w-4" />Antrenorler</Link>
            </Button>
            <Button variant="outline" className="w-full justify-start" asChild>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/tesis/ogrenciler">Tum Ogrenciler</Link>
            </Button>
          </div>
        </CardHeader>
        <CardContent>
