  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-4">
              <a href={`tel:${config.telefon.replace(/\s/g, "")}`} className="flex items-center gap-3 text-zinc-300 hover:text-white transition">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-xl hover:bg-green-600 hover:scale-110 transition-all"
      >
