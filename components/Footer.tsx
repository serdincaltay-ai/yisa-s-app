        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Yeni Nesil Spor Akademisi Sistemi. Franchise yonetimi, sporcu takibi, veli paneli ve daha fazlasi.
            </p>
          </div>

          {/* Iletisim Bilgileri */}
          <div className="space-y-3">
            <h4 className="text-sm font-semibold text-white uppercase tracking-wider">Iletisim</h4>
