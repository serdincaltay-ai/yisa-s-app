      ...
      <div className="w-full max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-12">
          <div className="inline-block mb-6">
            {logoUrl ? (
              <Image src={logoUrl} alt={siteName} width={128} height={128} className="h-32 w-auto object-contain" unoptimized />
            ) : (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:scale-105 transition-transform duration-300 hover:border-white/30">
            ...
            <div className="space-y-3">
              ...
              <Link href="/panel/ogrenciler" className="block w-full bg-zinc-800 hover:bg-zinc-700 text-white py-3 rounded-lg font-semibold transition text-center">
                Ders Programı
              </Link>
